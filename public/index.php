...
//Simpan data url pada variabel
$url = isset($_GET['url']) ? $_GET['url'] : '';

//Memanggil file konfigurasi library yg dibutuhkan
...
//Membuat function untuk mengatur pesan eror
...
function callHook() {
    ...
    $controllerPath = ROOT.'/aplication/controllers/'. ucfirst($controller) .'Controller.php';
